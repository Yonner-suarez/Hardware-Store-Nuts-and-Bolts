      ...
      <div>
        ...
        <Carousel data-bs-theme="dark" className={styles.d_container_carrusel}>
          <Carousel.Item className={styles.d_container_img_carrusel_item_b_d}>
            <Carousel.Caption
              className={styles.d_container_img_carrusel_caption}
            >
              <img
          ...
          <Carousel.Item
            className={styles.d_container_img_carrusel_item_mikita}
          >
            <Carousel.Caption
              className={styles.d_container_img_carrusel_caption}
            >
          ...
          <Carousel.Item
            className={styles.d_container_img_carrusel_item_dewalt}
          >
            <Carousel.Caption
              className={styles.d_container_img_carrusel_caption}
            >
